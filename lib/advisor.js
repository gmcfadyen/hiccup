...
const INDICATOR_COVERED = ['t38', 'precondition', 'early-media', 'dns', 'diameter', 'stun-ice', 'dtls-srtp'];
...
RULES.push({
  ...
  build: (m, analysis, ctx) => {
    ...
    return {
      ...
      legIds: [], callIds: arr(i.evidenceCallIds), msgIds: arr(i.evidenceMsgIds).slice(0, 8),
